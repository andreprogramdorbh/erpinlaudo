...
DROP PROCEDURE IF EXISTS sp_migrate_contrato_exames;

DELIMITER $$

CREATE PROCEDURE sp_migrate_contrato_exames()
BEGIN
    -- Criar tabela contrato_exames se não existir
    IF NOT EXISTS (
...
CALL sp_migrate_contrato_exames();
DROP PROCEDURE IF EXISTS sp_migrate_contrato_exames;
