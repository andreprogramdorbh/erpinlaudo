...
ALTER TABLE `cnes_profissionais`
  ...
  ADD COLUMN IF NOT EXISTS `nu_registro_conselho`   VARCHAR(30)  DEFAULT NULL AFTER `nu_registro`,
  ADD COLUMN IF NOT EXISTS `sg_uf_crm`              VARCHAR(2)   DEFAULT NULL AFTER `nu_registro_conselho`,
  ADD COLUMN IF NOT EXISTS `sg_uf_conselho`         VARCHAR(2)   DEFAULT NULL AFTER `sg_uf_crm`,
  ADD COLUMN IF NOT EXISTS `ind_vinculacao`     VARCHAR(5)   DEFAULT NULL AFTER `sg_uf_conselho`,
