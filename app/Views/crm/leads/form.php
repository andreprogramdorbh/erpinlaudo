...
<div class="crm-form-wrap">
  ...
  <div class="crm-tabs">
    ...
    <div class="crm-tab <?php echo (!$isEdit ? 'crm-tab-locked' : ($activeTab === 'anexos' ? 'active' : '')); ?>"
      ...
      <span class="badge bg-success rounded-pill ms-1" style="font-size:.65rem"><?php echo count($anexos); ?></span>
      <?php endif; ?>
    </div>
  </div>
  ...
  <div class="crm-body" id="tab-anexos" style="display:<?php echo $activeTab === 'anexos' ? 'block' : 'none'; ?>">
    ...
    <div class="anx-form-card">
      ...
      <form method="POST" action="/crm/leads/anexo/upload" enctype="multipart/form-data">
        ...
        <input type="hidden" name="related_id" value="<?php echo $lead->id; ?>">
        <div class="form-grid form-grid-3">
          <div class="form-group">
