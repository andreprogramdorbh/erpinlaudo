...
$statusConfig = [
    ...
    'entregue'   => ['label' => 'Entregue',    'bg' => '#d1fae5', 'color' => '#065f46'],
    'faturado'   => ['label' => 'Faturado',    'bg' => '#ede9fe', 'color' => '#5b21b6'],
...
.pv-table th { background:#f8fafc; font-size:12px; text-transform:uppercase; letter-spacing:.5px; color:#6b7280; font-weight:600; padding:10px 14px; }
.pv-table td { padding:12px 14px; vertical-align:middle; }
...
<div class="alert alert-success alert-dismissible fade show" role="alert">
    <i class="fas fa-check-circle me-2"></i> Pedido de venda criado com sucesso!
    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
</div>
<?php elseif ($success === 'atualizado'): ?>
<div class="alert alert-success alert-dismissible fade show" role="alert">
    <i class="fas fa-check-circle me-2"></i> Pedido de venda atualizado com sucesso!
    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
</div>
<?php elseif ($success === 'excluido'): ?>
<div class="alert alert-success alert-dismissible fade show" role="alert">
    <i class="fas fa-check-circle me-2"></i> Pedido de venda excluído com sucesso!
    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
</div>
<?php elseif ($success === 'expedido'): ?>
<div class="alert alert-success alert-dismissible fade show" role="alert">
...
<div class="row g-3 mb-4">
    <div class="col-6 col-md-3">
        <div class="kpi-card">
            <div class="kpi-icon" style="background:#dbeafe;">
                <i class="fas fa-file-invoice" style="color:#1e40af;"></i>
            </div>
            <div>
    ...
    <div class="col-6 col-md-3">
        <div class="kpi-card">
            ...
            <div>
                <div class="kpi-val" style="color:#059669;"><?= $fmtN($kpis->entregue ?? 0) ?></div>
    ...
    <div class="col-6 col-md-3">
        <div class="kpi-card">
            ...
            <div>
                ...
                <div class="kpi-lbl">Faturado no Mês</div>
            </div>
        </div>
    </div>
</div>
...
<div class="filtro-bar">
    <form method="GET" action="/estoque/vendas" class="row g-2 align-items-end">
        <div class="col-md-4">
        ...
        <div class="col-md-2 d-flex gap-2">
            ...
            <a href="/estoque/vendas" class="btn btn-outline-secondary btn-sm" title="Limpar filtros">
...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="/estoque/vendas/create" class="btn btn-success btn-sm">
        <i class="fas fa-plus me-1"></i> Novo Pedido de Venda
    </a>
</div>
...
<div class="card border-0 shadow-sm">
    <div class="card-body p-0">
        ...
        <div class="table-responsive">
            <table class="table table-hover align-middle mb-0 pv-table">
                <thead>
                    <tr>
                        <th>Nº PEDIDO</th>
                        <th>DATA</th>
                ...
                <tbody>
                    ...
                    <tr>
                        <td>
                            <a href="/estoque/vendas/<?= (int)$p->id ?>" class="fw-bold text-success text-decoration-none">
                                <?= $esc($p->numero ?? '#' . $p->id) ?>
                            </a>
                        </td>
                        ...
                        <td>
                            <div class="fw-semibold"><?= $esc($p->cliente_nome ?? '—') ?></div>
                            <?php if (!empty($p->cliente_cpf_cnpj)): ?>
                            <div class="small text-muted"><?= $esc($p->cliente_cpf_cnpj) ?></div>
                            <?php endif; ?>
                        </td>
                        ...
                        <td class="text-end">
                            <?php
                            $margem = (float)($p->margem_total ?? 0);
                            $cor    = $margem >= 0 ? 'text-success' : 'text-danger';
                            ?>
                            <span class="<?= $cor ?> fw-semibold"><?= $fmt($margem) ?></span>
                        </td>
                        <td class="text-center">
        ...
        <div class="text-center py-5">
            ...
            <p class="text-muted mb-1">Nenhum pedido de venda encontrado.</p>
            <a href="/estoque/vendas/create" class="btn btn-success btn-sm mt-2">
                <i class="fas fa-plus me-1"></i> Criar Primeiro Pedido de Venda
            </a>
        </div>
        <?php endif; ?>
    </div>
...
function confirmarExclusao(id, numero) {
    ...
    document.getElementById('formExcluir').action = '/estoque/vendas/' + id + '/delete';
