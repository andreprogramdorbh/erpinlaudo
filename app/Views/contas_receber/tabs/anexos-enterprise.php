...
<section class="form-section">
    ...
    <div class="card border-0 shadow-sm mb-4">
        <div class="card-body">
            <form method="POST" action="/financeiro/contas-a-receber/anexos/upload" enctype="multipart/form-data" class="row g-3 align-items-end">
                <input type="hidden" name="conta_receber_id" value="<?php echo (int)$contaId; ?>">
    ...
    <div class="card border-0 shadow-sm">
        <div class="card-body p-0">
            ...
            $rowRenderer = function ($a) {
                ...
                $download = '<a class="text-primary me-2" href="/financeiro/contas-a-receber/anexos/download/' . (int)$a->id . '" title="Baixar"><i class="fas fa-download"></i></a>';
...
function confirmDeleteAnexo(id) {
    if (confirm('Deseja remover este anexo?')) {
        ...
        form.method = 'POST';
        form.action = '/financeiro/contas-a-receber/anexos/delete/' + id;
